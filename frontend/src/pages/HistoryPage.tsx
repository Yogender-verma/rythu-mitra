  ...
  return (
    <div className="space-y-6 text-black">
      ...
      <div className="bg-white p-6 rounded-3xl border-2 border-[#B7C9B3] shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <span className="text-xs font-black uppercase tracking-wider text-[#1B5E20] bg-[#C8E6C9] px-3 py-1 rounded-full border border-[#B7C9B3]">Diagnosis Archive</span>
      ...
      {loading ? (
        ...
        <div className="bg-white p-12 rounded-3xl border-2 border-[#B7C9B3] text-center space-y-3">
          ...
          <p className="text-xs text-black font-black">Try adjusting your search query or filters.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filteredScans.map((scan) => (
            <div
              ...
              className="bg-white p-5 rounded-3xl border-2 border-[#B7C9B3] shadow-sm flex items-center justify-between group"
            >
              <div className="flex items-center gap-4 min-w-0">
                ...
                <div className="min-w-0 space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {scan.diagnosis?.risk_level || 'Normal'}
                    </span>
                  </div>

                  <h3 className="text-sm font-black text-black truncate text-telugu">
                    {scan.diagnosis?.disease_te || scan.diagnosis?.disease_en || scan.diagnosis?.disease}
                  </h3>
